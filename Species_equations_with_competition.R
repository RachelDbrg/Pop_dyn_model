...
equa_diff_sp <- function(t,y, Parms){
  ...
  with(as.list(parms), {
    ...
    # Feuillus
    # Modèle exponentiel - on considere que seuls les adultes mangent des vegetaux
    ...
    dPjdt <- chi_P * surplus_NRJ * Pa * (1) - tau_p * Pj #- 0.4*Pj #(pup death)
