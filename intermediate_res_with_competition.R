...
# ==============================================================================
  ...
  # print(paste("NRJ apportée par Q", epsi_MC * (rfonc_P_Qa + rfonc_P_Qj *epsi_Caj)))
  ...
  # print(paste("surplusNRJ", surplus_NRJ))
  # print(paste("NRJ_intake", NRJ_intake))
  # print(paste("mu_P", mu_P))
  ...
  # Ca_supplementary_NRJ <- ((a_C * e_UC * U)/(1 + a_C * h_UM * U) - mu_C)
